...
import com.example.hoodstudio_carpentryapp.Employee.EmpViewOrders;
...
public class AdminViewOrders extends AppCompatActivity {
    ...
    private ImageAdapterAdminVieworders mAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter = new ImageAdapterAdminVieworders(AdminViewOrders.this, mUploads);
        ...
        mDBListener = mDatabaseRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(AdminViewOrders.this, error.getMessage(), Toast.LENGTH_SHORT).show();
                mProgressCircle.setVisibility(View.INVISIBLE);
            }
        });
    ...
    public void onBackPressed() {
        startActivity(new Intent(AdminViewOrders.this, AdminHome.class));
        finish();
    }
}