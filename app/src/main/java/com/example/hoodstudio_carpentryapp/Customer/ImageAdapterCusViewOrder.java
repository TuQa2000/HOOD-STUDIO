...
public class ImageAdapterCusViewOrder extends RecyclerView.Adapter <ImageAdapterCusViewOrder.ImageViewHolder>{

    private Context mContext;
    private List<UserOrder> mUploads, mUploads1;

    public ImageAdapterCusViewOrder(Context context, List<UserOrder> userUploads){
        mContext= context;
    ...
    public ImageViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v= LayoutInflater.from(mContext).inflate(R.layout.image_view_cus_view_order, parent, false);
    ...
    public class ImageViewHolder extends RecyclerView.ViewHolder{
        ...
        public ImageViewHolder(@NonNull View itemView) {
            super(itemView);
            textViewCusName= itemView.findViewById(R.id.image_view_cus_name7);
            textViewCusPhone= itemView.findViewById(R.id.image_view_cus_phone7);
            textViewStatus= itemView.findViewById(R.id.image_view_status7);
            textViewName= itemView.findViewById(R.id.image_view_name7);
            textViewPrice= itemView.findViewById(R.id.image_view_price7);
            textViewSize= itemView.findViewById(R.id.image_view_size7);
            textViewDetail= itemView.findViewById(R.id.image_view_detail7);
            textViewAddress= itemView.findViewById(R.id.image_view_address7);
